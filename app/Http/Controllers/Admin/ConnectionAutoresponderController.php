...
class ConnectionAutoresponderController extends Controller
{
     ...
     * @param ConexaoApiGoogleService $conexaoApiGoogleService
    ...
    public function __construct(AutoresponderService $autoresponderService, MensagemService $messageService,
                                ConexaoApiGoogleService $conexaoApiGoogleService, UploadCredentialFile $credentialFile)
    {
        $this->autoresponderService     = $autoresponderService;
        $this->messageService           = $messageService;
        $this->conexaoApiGoogleService  = $conexaoApiGoogleService;
...
//
//            $responseApi = $this->conexaoApiGoogleService->getResponse($file_credential_decoded->project_id, uniqid(), $arrayWithFields['message']);
//
//            http_response_code(200);
//
//            echo json_encode(
